...
RUN set -x && \
    ...
    wget -O $OTP_GRAPHS/switzerland/timetable-gtfs.zip https://opentransportdata.swiss/de/dataset/timetable-2021-gtfs2020/permalink && \
    unzip $OTP_GRAPHS/switzerland/timetable-gtfs.zip routes.txt -d $OTP_GRAPHS/switzerland && \
    sed -i -- 's/"Aufzug","1700"/"Aufzug","1303"/g' $OTP_GRAPHS/switzerland/routes.txt && \
    ...
    sed -i -- 's/"Taxi","1500"/"Taxi","715"/g' $OTP_GRAPHS/switzerland/routes.txt && \
    zip -ju $OTP_GRAPHS/switzerland/timetable-gtfs.zip $OTP_GRAPHS/switzerland/routes.txt && \
    ...
    rm $OTP_GRAPHS/switzerland/timetable-gtfs.zip && \
